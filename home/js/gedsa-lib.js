var util = {
    root: "/home/",
    loaderHtml: "<div style=\"text-align: center;\" id=\"loading\"><img src=\"/home/img/sys_admin/load.gif\" /><br />Cargando...</div>",
    currentUrl: $(location).attr("href"),
    /**
     * 
     * @param {type} data {url:"", data:{}, container:"selector", innerHtml: "html", back: boolean, server:boolean} server: indica que utilizara la url apartir de los directorios del servidor
     * @returns {undefined}
     */
    load: function(data) {
